    ...
    <div className="p-8 space-y-12 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-slate-300 text-lg max-w-3xl mx-auto mb-8 font-normal leading-relaxed">
          ReviewMiner AI is an enterprise-grade NLP and Machine Learning platform. Upload any review dataset to perform automated schema detection, interactive EDA, sentiment distribution, supervised ML classification, and executive PDF reporting.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-8 py-4 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-white/10 text-slate-200 font-semibold text-base transition-all duration-200"
          >
